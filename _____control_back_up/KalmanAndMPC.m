...
transMap = casadi.interpolant('LUT','bspline',{[0,20,30,50,60,70,80,90,100]}, [0,0.2244,0.3850,0.6309,0.7839,1.022,1.1630,1.3959,1.5340]);
...
for i = 1:Ns
    ...
    for k = 1:N-1
        ...
        w = {w{:}, uk};
        lbw = [lbw; [0; 0]]; % input should be constrained to [0%, 100%]
        ubw = [ubw; [100; 100]];
        w0 = [w0; [0; 0]];
    ...
    % correction step
    y = x_prior([1,2,6]) + noise; % simulate the noise : add random noise to estimated states
